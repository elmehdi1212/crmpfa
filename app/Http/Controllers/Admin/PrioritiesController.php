...
class PrioritiesController extends Controller
{
    ...
    public function store(StorePriorityRequest $request)
    {
        ...
        return redirect()->route('admin.priorities.index')->withSuccessMessage('successfully added');
    }
    ...
    public function update(UpdatePriorityRequest $request, Priority $priority)
    {
        ...
        return redirect()->route('admin.priorities.index')->withSuccessMessage('successfully updated');;
    }
