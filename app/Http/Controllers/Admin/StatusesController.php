...
class StatusesController extends Controller
{
    ...
    public function store(StoreStatusRequest $request)
    {
        ...
        return redirect()->route('admin.statuses.index')->withSuccessMessage('successfully added');
    }
    ...
    public function update(UpdateStatusRequest $request, Status $status)
    {
        ...
        return redirect()->route('admin.statuses.index')->withSuccessMessage('successfully updated');
    }
