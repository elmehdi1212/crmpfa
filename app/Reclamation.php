...
class Reclamation extends Model implements HasMedia
{
    ...
    public static function boot()
    {
        ...
        Reclamation::observe(new \App\Observers\ReclamationActionObserver);
    ...
    {
        return $this->hasMany(Comment::class, 'reclamation_id', 'id');
    }
    ...
    public function scopeFilterReclamations($query)
    {
        ...
        $users = \App\User::where(function ($q) {
                ...
                ->where(function ($q) {
                    $q->whereHas('comments', function ($q) {
                        return $q->whereReclamationId($this->id);
                    })
                    ->orWhereHas('reclamations', function ($q) {
